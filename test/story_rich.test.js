...
assert.ok(/has-working-status/.test(storyView) && css.includes('.story-panel.has-working-status .story-latest-btn'),
  'Latest clears the detailed live-status footer instead of covering it');
