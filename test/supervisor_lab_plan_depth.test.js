...
const accepted = [
  ...
  'Replace the six phases with one bounded implementation-and-verification step covering the label, focused assertion, and test run.',
...
const rejected = [
  ...
  'Use one bounded backoff and then run the focused test.',
