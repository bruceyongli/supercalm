...
// Exercise the correction on one of the two current operating models. The captured GLM sentence
// remains the public grammar fixture; the correction mechanism itself is model-agnostic.
...
await check('exposedModelMismatch: exact equality, absent id passes', async () => {
  ...
  assert.equal(exposedModelMismatch(MODEL, 'claude-opus-4-8', ''), true);
});
