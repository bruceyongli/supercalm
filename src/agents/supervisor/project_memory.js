...
export function renderBetweenTasksMd(lastTask) {
  return [
    ...
    '> stand by for the operator to start or adopt the next task card. Choosing, starting, or closing',
    "> cards is the OPERATOR's call: never direct it, on this project or any other.",
    '',
